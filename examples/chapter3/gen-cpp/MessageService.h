...
class MessageServiceIf {
 public:
  ...
  virtual void lastestMessage(Message& _return) = 0;
};
...
class MessageServiceNull : virtual public MessageServiceIf {
 public:
  ...
  void lastestMessage(Message& /* _return */) {
    return;
  }
};


class MessageService_lastestMessage_args {
 public:

  MessageService_lastestMessage_args(const MessageService_lastestMessage_args&);
  MessageService_lastestMessage_args& operator=(const MessageService_lastestMessage_args&);
  MessageService_lastestMessage_args() {
  }

  virtual ~MessageService_lastestMessage_args() noexcept;

  bool operator == (const MessageService_lastestMessage_args & /* rhs */) const
  {
    return true;
  }
  bool operator != (const MessageService_lastestMessage_args &rhs) const {
  ...
  bool operator < (const MessageService_lastestMessage_args & ) const;
...
class MessageService_lastestMessage_pargs {
 public:


  virtual ~MessageService_lastestMessage_pargs() noexcept;

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

};

typedef struct _MessageService_lastestMessage_result__isset {
  _MessageService_lastestMessage_result__isset() : success(false) {}
  bool success :1;
} _MessageService_lastestMessage_result__isset;

class MessageService_lastestMessage_result {
 public:

  MessageService_lastestMessage_result(const MessageService_lastestMessage_result&);
  MessageService_lastestMessage_result& operator=(const MessageService_lastestMessage_result&);
  MessageService_lastestMessage_result() {
  }

  virtual ~MessageService_lastestMessage_result() noexcept;
  Message success;

  _MessageService_lastestMessage_result__isset __isset;

  void __set_success(const Message& val);

  bool operator == (const MessageService_lastestMessage_result & rhs) const
  {
  ...
  bool operator < (const MessageService_lastestMessage_result & ) const;
...
typedef struct _MessageService_lastestMessage_presult__isset {
  _MessageService_lastestMessage_presult__isset() : success(false) {}
  bool success :1;
} _MessageService_lastestMessage_presult__isset;

class MessageService_lastestMessage_presult {
 public:


  virtual ~MessageService_lastestMessage_presult() noexcept;
  Message* success;

  _MessageService_lastestMessage_presult__isset __isset;
...
class MessageServiceClient : virtual public MessageServiceIf {
 ...
 public:
  ...
  void lastestMessage(Message& _return);
  void send_lastestMessage();
  void recv_lastestMessage(Message& _return);
 protected:
...
class MessageServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 private:
  ...
  void process_lastestMessage(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 public:
  MessageServiceProcessor(::std::shared_ptr<MessageServiceIf> iface) :
    iface_(iface) {
    processMap_["lastestMessage"] = &MessageServiceProcessor::process_lastestMessage;
  }
...
class MessageServiceMultiface : virtual public MessageServiceIf {
 ...
 public:
  void lastestMessage(Message& _return) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->lastestMessage(_return);
    }
    ifaces_[i]->lastestMessage(_return);
    return;
  }
  ...
  MessageServiceConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
 ...
 public:
  ...
  void lastestMessage(Message& _return);
  int32_t send_lastestMessage();
  void recv_lastestMessage(Message& _return, const int32_t seqid);
 protected:
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot_;
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot_;
  ::apache::thrift::protocol::TProtocol* iprot_;
